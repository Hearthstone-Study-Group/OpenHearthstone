...
for batch in (pbar := tqdm(train_loader)):
    ...
    print("Input state:")
    input_state_str = policy_model.tokenizer.decode(input_ids_state.squeeze(), skip_special_tokens=True)
    ...
    next_state_str = policy_model.tokenizer.decode(input_ids_next_state.squeeze(), skip_special_tokens=True)
